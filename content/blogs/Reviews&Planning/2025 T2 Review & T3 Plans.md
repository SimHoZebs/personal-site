...
And that leads to another minor complaint - there is a desire for engineers to learn new technologies and try ideas that may fail, but the pressure to hit deadlines for existing projects makes it much easier to lean on tried & tested tools. Without dedicating a decent amount of work time keeping up with modern tech trends, there's little time to identify better way to do things, real danger of falling behind, and limit innovation. I do not want to be someone who only knows how to get things done the way Amazon does things, and I learned that there needs be some effort beyond work necessary for that.
