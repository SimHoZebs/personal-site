...
---
My philosophy in what software should achieve are as follows:
- Should be built to be used offline as much as possible.
...
- Software developer should not obligated to provide means to make or control changes, but should not explicitly prevent users from doing so.

My [Workplaces of interest](https://www.notion.so/Workplaces-of-interest-d890be5c93f74a498013f7e5d41958ea?pvs=21) should reflect some amount of this.

Back in the old days, YouTube channel pages were customizable. I'm not talking about the banner; I mean the entire page. This was a feature locked behind the YouTube Partners Program, which was the only way a channel could monetize its videos back then.

Just a few months after I started my Minecraft YouTube channel, YouTube changed its policy to allow anyone to monetize their video, along with a massive visual overhaul. Among them included the removal of channel customization. Every channel looked the same -  you couldn't even put up a banner like you can now. People were furious, and even now, a handful of people miss the level of personalization and branding capabilities of the older YouTube.

Countless more controversial changes have been made since then (Please bring back the dislike button), all of which we never really had a say in. Sure, we had _some_ say. Companies are, in some ways, bound to design their products to be desirable. But in the past few years, YouTube and many other companies have made more and more questionable, even outright anti-consumer decisions that resulted not in the loss, but in fact, improvement to their infinite growth. Turns out, they never had to give us what we want in order for us to stay.
...
- People should own the version of the software they pay for.
    - The definition of ‘own’ is the right to make and control changes within the purchased version of the software.
- Software developer should not obligated to provide means to make or control changes, but should not explicitly prevent users from doing so.
- Should be secure, GDPR compliant, and have end-to-end encryption.
...
This post has been heavily influenced by [Jacky's incredible post](https://jzhao.xyz/posts/towards-data-neutrality/), and I highly recommend reading it for a deeper dive into the concept of data neutrality.

## On Blockchain
While often touted as a solution for decentralization, I believe blockchain is a failure in this regard. The countless failures of cryptocurrencies prove its shortcomings. Its requirement for validators necessitates an incentive structure, which has so far only been successfully implemented through monetary rewards, re-centralizing power. My focus instead has been on P2P technologies.

## Challenges for Data-Neutral Apps

### Recommendation & Discovery
A major challenge for data-neutral applications is content discovery. Without a centralized server to analyze user data and behavior, it's difficult to provide the personalized recommendations that users of platforms like YouTube and Spotify have come to expect. This makes it harder for new creators to be discovered and for users to find new content.

### Competition with Centralized Alternatives
Centralized data is incredibly powerful. Services built on it can offer features that data-neutral apps simply cannot, such as sophisticated analytics, large-scale social features, and seamless multi-device experiences. The success of data-neutral alternatives ultimately depends on a critical mass of users prioritizing privacy and data ownership over the conveniences offered by centralized platforms.
