...
Even if you disable all tracking and telemetry options on your device, you will always share some data with your proprietary operating system provider and their third-party money-makers.

Problems with dualbooting with a Linux/GNU system:

- Outlook is only available on the browser.
  - The browser version is fully featured, though.
- No adobe applications. This means no pdf signing, video editing.
  The solution, is of course, to use an open-source alternative, like Ubuntu(x86/ARM systems) and LineageOS (mobile). **However, I am going to keep using anything about it.**

### Solution:

- Linux-based operating system for software development
- Windows and Mac are terrible options, of course
...
There are multiple forms of private communications.
- Direct 1-to-1 or small group communication with minimal to zero management tools. This refers to apps like Signal, Telegram, WhatsApp, Kakaotalk, etc.
- Larger communities such as a classroom, college, and companies need management tools such as 'channels' to separate discussions and the banhammer. This refers to apps like Element (Matrix), Discord, Slack and Microsoft Teams.
...
3. E2EE RCS (only texts and files)
   - E2EE, but RCS is a closed standard. What's [available online](https://www.gsma.com/newsroom/wp-content/uploads//RCC.71-v2.5-6.pdf) seems old.
   - RCS itself is not E2EE. Apple does not support it in their implementation.
   - Replacing SMS, meaning vast majority of the US will use it eventually.
4. WhatsApp
   - E2EE, but do I trust Meta to not have a backdoor for governments or for themselves?
   - Most popular alternative to SMS at the moment.
...
## Finance
Privacy.com protects you from being locked to a subscription by allowing you to make virtual cards. Made an account for Jen.
