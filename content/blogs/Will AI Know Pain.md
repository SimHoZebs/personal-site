...
What even drives us to innovate in the first place? We didn't invent software engineering for the sake of it. It's a way we represent the solutions to the problems we experienced yesterday, today, and expect to experience tomorrow. Those experiences are much more complex than what the best LLM can absorb from training text alone. For an AI to truly originate innovation, it cannot merely imitate the language we use after we've already solved the problem. It must experience the constraints of the living.
